...
import com.turntalienn.mytrade.trading.domain.forex.feed.SignalBuilder;
...
import static com.turntalienn.mytrade.trading.domain.forex.order.OrderDto.OrderOrigin.EXITS;
import static com.turntalienn.mytrade.trading.domain.forex.order.OrderDto.OrderOrigin.STOP_ORDER;
import static com.turntalienn.mytrade.trading.domain.forex.order.OrderDto.OrderStatus.CREATED;
import static com.turntalienn.mytrade.trading.domain.forex.order.OrderDto.OrderStatus.EXECUTED;
...
public class OrderDomainShould extends TestCase {
    ...
    public void create_order_from_signal_event() {
        OrderService orderService = OrderFactory.create(this.riskManagementService);
    ...
    public void persist_order() {
        OrderService orderService = OrderFactory.create(riskManagementService);
